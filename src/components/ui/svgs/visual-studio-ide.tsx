...
/**
 * Visual Studio (IDE) mark (plain). Path from Devicon (MIT), adapted for
...
const defaultColor = "#52218A"

const SiVisualStudioIde = React.forwardRef(function SiVisualStudioIdeInner(
  {
    title = "Visual Studio",
    color = "currentColor",
    size = 24,
