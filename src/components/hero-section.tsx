                    ...
                    <div className="pb-24 pt-12 md:pb-32 lg:pb-56 lg:pt-44">
                        <div className="relative mx-auto flex max-w-6xl flex-col px-6 lg:block">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:w-1/2 lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl font-medium md:text-6xl lg:mt-16 xl:text-7xl">Ivan Bondaruk</h1>
                                <p className="mt-8 max-w-2xl text-pretty text-lg">Software developer and creative professional building modern web applications.</p>

                                <div className="mt-12 flex flex-col items-center justify-center gap-2 sm:flex-row lg:justify-start">
                                    <Button size="lg" className="px-5 text-base" render={<Link href="#" />} nativeButton={false}><span className="text-nowrap">Start Building</span></Button>
                                    <Button key={2} size="lg" variant="ghost" className="px-5 text-base" render={<Link href="#" />} nativeButton={false}><span className="text-nowrap">Request a demo</span></Button>
                                </div>
                            </div>
