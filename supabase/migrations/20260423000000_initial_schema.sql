 ...
 *
 * Initial schema (single migration). Replaces the chain archived in
 * supabase/migration_archive/:
 *   20260322000000_create_testimonials_and_social_links.sql
 *   20260322100000_create_profiles.sql
 *   20260322110000_create_companies.sql
 *   20260322120000_create_apps_and_stats.sql
 *   20260322130000_social_links_rls.sql
 *   20260322140000_create_stats_api_credentials.sql
 *   20260322150000_company_creation_rls.sql
 *   20260322160000_social_links_authenticated_read.sql
 *   20260322170000_testimonials_authenticated_rls.sql
 *   20260322180000_seed_testimonials_if_empty.sql
 *   20260322190000_create_certificates.sql
 *   20260323000000_create_projects.sql
 *   20260323010000_create_faq_sets_and_items.sql
 *   20260323020000_seed_landing_faq.sql
 *   20260328000000_create_about_timeline.sql
 *   20260329120000_restrict_permissive_authenticated_rls.sql
 *   20260329140000_ensure_landing_company_exists.sql
 *   20260330120000_baseline_schema.sql
 *   20260330130000_fix_company_members_rls_recursion.sql
 *
 * This file is the canonical final state (not a line-by-line merge of the
 * above): e.g. company_id on certificates and faq_sets, is_company_member()
 * for RLS, landing-only UPDATE for testimonials/social_links, etc.
 *
...
-- Squash (2026-04-23): after replacing incremental migrations, run locally:
--   supabase db reset
-- (requires Supabase CLI + Docker for local stack). For a remote project that
-- still has old row(s) in supabase_migrations, align history with
--   supabase migration repair
-- before applying this as the new single baseline (see Supabase CLI docs).
